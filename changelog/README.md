...
Per-change notes for the GroupDocs.Merger.Mcp integration tests repo, captured
...
id: 001
date: 2026-04-23
package-under-test: 26.4.4   # version of GroupDocs.Merger.Mcp the suite targets
...
`package-under-test` field records which `GroupDocs.Merger.Mcp` version the
