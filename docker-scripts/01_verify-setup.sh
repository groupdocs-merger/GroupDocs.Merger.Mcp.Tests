...
main() {
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Merger.Mcp — Setup Verification      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
    ...
    # Check test project
    if [ -d "$PROJECT_ROOT/src/GroupDocs.Merger.Mcp.Tests" ]; then
        print_pass "Test project found"
    else
        print_fail "Test project not found: $PROJECT_ROOT/src/GroupDocs.Merger.Mcp.Tests"
    fi
    
    # Check csproj
    if [ -f "$PROJECT_ROOT/src/GroupDocs.Merger.Mcp.Tests/GroupDocs.Merger.Mcp.Tests.csproj" ]; then
    ...
    local mcp_image="ghcr.io/groupdocs-merger/merger-net-mcp:latest"
