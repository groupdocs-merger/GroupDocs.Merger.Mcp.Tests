#!/bin/bash
################################################################################
# GroupDocs.Merger.Mcp — Integration Test Runner (local)
#
...
#
# Scenarios:
#   - ToolDiscovery (server handshake, 3-tool listing)
#   - Merge (2-way + 3-way DOCX, 2-way PDF)
#   - Split (10-page DOCX page extraction, unparseable-pages guard, protected PDF)
...
#   --filter PATTERN        Run only tests matching pattern (e.g., Merge)
...
#   ./02_test-all-scenarios.sh --version 26.5.0 --filter Merge
...
TEST_PROJECT_DIR="$PROJECT_ROOT/src/GroupDocs.Merger.Mcp.Tests"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Merger.Mcp — Integration Test Runner (local) ║"
    echo "╚════════════════════════════════════════════════════════════╝"
    echo ""
