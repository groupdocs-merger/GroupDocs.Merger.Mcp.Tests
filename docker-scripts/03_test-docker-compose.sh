#!/bin/bash
################################################################################
# GroupDocs.Merger.Mcp — Docker-Compose Integration Test Runner
#
...
#   ./03_test-docker-compose.sh --filter Merge --keep
#
################################################################################
...
services:
  test-runner:
    ...
    working_dir: /workspace/src/GroupDocs.Merger.Mcp.Tests
    environment:
      DOTNET_NOLOGO: "true"
...
main() {
    ...
    echo ""
    echo "╔════════════════════════════════════════════════════╗"
    echo "║  GroupDocs.Merger.Mcp — Docker Test Runner      ║"
    echo "╚════════════════════════════════════════════════════╝"
    echo ""
