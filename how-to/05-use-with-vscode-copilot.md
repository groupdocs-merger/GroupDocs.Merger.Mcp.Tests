...
The [NuGet.org package page](https://www.nuget.org/packages/GroupDocs.Merger.Mcp)
...
```
@workspace merge /docs/intro.docx and /docs/appendix.docx into one file

Use split to extract pages 2, 4, and 6 from /docs/report.pdf

How many pages does /docs/presentation.pptx have?
```
...
Without a license, all three tools still work — `merge` / `split` output
just carries an evaluation watermark (see
